...
public class MyJson {// score 3
    ...
    public static void writeToFile(String inputToWrite, String filePath) throws IOException {
        File newFile = new File(filePath + "/res.txt");
    ...
    public static void main(String[] args) throws IOException {
        File file = new File("/Users/mana/Documents/GitHub_New/neu-sep17/assignments/Assignment_8/Question3_camino.txt");
        ArrayList<Vehicle> vehicles = readAndGetVehicles(file);
        String str = getJsonString(vehicles);
        writeToFile(str, file.getParent());
    }
